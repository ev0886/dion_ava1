...
def test_rusguard_acm_status_transport_uses_vendor_card_read_sequence_on_selected_serial_endpoint() -> None:
...
class _FakeRusGuardSdk:
    ...
    def RG_SetCardsMask(self, endpoint_ptr, address: int, mask: int) -> int:
        self.calls.append(("RG_SetCardsMask", _endpoint_address(endpoint_ptr), address, mask))
        return 0
