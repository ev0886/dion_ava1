(function () {
  ...
  const OPEN_CELLS_AUTH_ERROR_TITLE = "\u0417\u0430\u043a\u0440\u043e\u0439\u0442\u0435 \u043e\u0442\u043a\u0440\u044b\u0442\u044b\u0435 \u044f\u0447\u0435\u0439\u043a\u0438";
  ...
  const screens = {
    ...
    userItemSuccess: {
      kicker: "\u0413\u043e\u0442\u043e\u0432\u043e",
      title: "\u0417\u0430\u0431\u0435\u0440\u0438\u0442\u0435 \u0442\u043e\u0432\u0430\u0440 \u0438 \u0437\u0430\u043a\u0440\u043e\u0439\u0442\u0435 \u044f\u0447\u0435\u0439\u043a\u0443!",
  ...
  async function readAndResolveRfid() {
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 400 && payload && payload.detail === "Authorization blocked: one or more cells are open") {
          showAuthError(OPEN_CELLS_AUTH_ERROR_TITLE);
          return;
        }
